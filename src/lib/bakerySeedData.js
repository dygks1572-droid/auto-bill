...
const BASE_PRODUCT_SEEDS = [
  ...
  product('플레인', {
    aliases: ['+ 플레인', 'ㄴ 플레인', '플레인 +0', '+0 플레인', '휘낭시에 플레인'],
    category: 'option',
    group: 'bakery-option',
    countInBakeryTotal: false,
    optionLike: true,
  ...
  product('무화과', {
    aliases: ['+ 무화과', 'ㄴ 무화과', '무화과 +400', '무화과 +400원', '휘낭시에 무화과'],
    category: 'option',
    group: 'bakery-option',
    countInBakeryTotal: false,
    optionLike: true,
  ...
  product('발로나초코', {
    aliases: ['+ 발로나초코', 'ㄴ 발로나초코', '발로나초코 +800', '발로나초코 +800원', '휘낭시에 발로나초코'],
    category: 'option',
    group: 'bakery-option',
    countInBakeryTotal: false,
    optionLike: true,
  ...
  product('약과', {
    aliases: ['+ 약과', 'ㄴ 약과', '약과 +400', '약과 +400원', '휘낭시에 약과'],
    category: 'option',
    group: 'bakery-option',
    countInBakeryTotal: false,
    optionLike: true,
  ...
  product('고르곤졸라크림치즈', {
    aliases: ['고르곤졸라 크림치즈', '+ 고르곤졸라크림치즈', 'ㄴ 고르곤졸라크림치즈', '고르곤졸라크림치즈 +600', '고르곤졸라크림치즈 +600원', '고르곤졸라 크림치즈 +600원', '휘낭시에 고르곤졸라크림치즈', '휘낭시에 고르곤졸라 크림치즈'],
    category: 'option',
    group: 'bakery-option',
    countInBakeryTotal: false,
    optionLike: true,
